...
public class RobotContainer {
    ...
    private void configureButtonBindings() {
        ...
        if (m_feeder.noteInRobot()) {
            m_driverController.getHID().setRumble(GenericHID.RumbleType.kLeftRumble, 1.0);
            m_driverController.getHID().setRumble(GenericHID.RumbleType.kRightRumble, 1.0);
        } else if (m_shooter.shooter1AtPodiumSetpoint()) {
