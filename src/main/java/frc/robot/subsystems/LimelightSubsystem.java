...
// m_limelightShooter = new HttpCamera("ShooterLL",
// "http://limelight-shooter:5809/stream.mjpg");
// m_limelightShooter.setResolution(320, 240);
// m_limelightShooter.setFPS(90);
// // m_limelightIntake = new HttpCamera("IntakeLL",
...
// return new Pose3d(new Translation3d(pose[0], pose[1], pose[2]), new
// Rotation3d(pose[3], pose[4], pose[5]));
// }

// public Pose3d getBotPoseBlue() {
// double[] pose = tableLeft.getEntry("botpose_wpiblue").getDoubleArray(new
// double[6]);
// return new Pose3d(new Translation3d(pose[0], pose[1], pose[2]), new
// Rotation3d(pose[3], pose[4], pose[5]));
// }
...
// double[] pose = tableLeft.getEntry("botpose_wpired").getDoubleArray(new
// double[6]);
// return new Pose3d(new Translation3d(pose[0], pose[1], pose[2]), new
// Rotation3d(pose[3], pose[4], pose[5]));
// }
...
// return new Transform3d(new Pose3d(0.0, 0.0, 0.0, new Rotation3d(0.0, 0.0,
// 0.0)), getBotPose());
// }
